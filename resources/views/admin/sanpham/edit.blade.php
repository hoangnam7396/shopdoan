        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-7" style="padding-bottom:120px">
                    ...
                    <form action="admin/sanpham/edit-product/{{$sanpham->id}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Tiêu Đề</label>
                            <input class="form-control" name="name" value="{{$sanpham->name}}" placeholder="Nhập tiêu đề tin tức" />
                        </div>
                        <div class="form-group">
                            <label>Mô Tả</label>
