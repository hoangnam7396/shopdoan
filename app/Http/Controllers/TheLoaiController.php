...
//            }
        ...
        $theloai->save();
        return redirect()->route('theloai.list')->with('thongbao','Thêm thể loại thành công');
    }
...
//        }else{
//            return back()->with('thongbao','Sửa như cứt');
//        }
        $theloai->save();
        $mess='Bạn đã sửa thành công sản phẩm: '.$theloai->name;
        return redirect()->route('theloai.list')->with('thongbao',$mess);
