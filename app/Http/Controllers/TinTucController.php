...
//            }
    ...
    public function postEdit(Request $request, $id)
    {
        ...
        $tintuc->title = $request->title;
        $tintuc->description = $request->description;
        $tintuc->content = $request->contents;
...
//                $hinh = str_random(5)."-".$name;
//            }
//            if(file_exists("upload/news/".$tintuc->image))
//            {
...
//            }
        ...
        $tintuc->save();
        $mess='Bạn đã sửa thành công tin tức có ID '.$id;
        return redirect()->route('tintuc.list')->with('thongbao',$mess);
    }
