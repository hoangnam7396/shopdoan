...
// Route::post('admin/dangnhap','UserController@postLogin')->name('admin.login');
...
Route::group(['prefix'=>'admin','middleware'=>'auth'],function()
{
	...
	{
		Route::get('list','TheLoaiController@getList')->name('theloai.list');
	...
	{
		Route::get('list','SanPhamController@getList')->name('sanpham.list');
		...
		Route::post('edit-product/{id}','SanPhamController@postEdit');
		Route::get('delete/{id}','SanPhamController@getDel');
	});

	Route::group(['prefix'=>'tintuc'],function()
	{
		Route::get('list','TinTucController@getList')->name('tintuc.list');
	...
	{
		Route::get('list','BillController@getList')->name('bill.list');
        ...
        Route::post('report','BillController@loadReport')->name('bill.load_report');
...
Route::get('news/{id}',[
	'as'=>'detailnews',
	'uses'=>'PageController@detailNews'
]);
Route::get('lienhe',[
	'as'=>'lienhe',
