	...
	<div id="content">
		<div class="row">
			<div class="col-sm-9">
				...
				<div class="woocommerce-tabs">
					...
					<div class="panel" id="tab-reviews">
						<p><div class="fb-comments" data-href="https://www.facebook.com/hdnamm" data-width="700" data-numposts="5"></div></p>
					</div>
				</div>
			...
			<div class="col-sm-3 aside">
				<div class="widget">
					<h3 class="widget-title">Sản Phẩm Trong Tầm giá</h3>
					<div class="widget-body">
						<div class="beta-sales beta-lists">
							@foreach($same_price as $row_price)
								<div class="media beta-sales-item">
									<a class="pull-left" href="product/{{$row_price->id}}"><img src="upload/product/{{$row_price->image}}" alt="{{$row_price->name}}"></a>
									<div class="media-body">
										<a class="pull-left" href="product/{{$row_price->id}}">{{$row_price->name}}</a>
										@if($row_price->promotion_price == 0)
											<div class="beta-sales-price">{{$row_price->unit_price}} VNĐ</div>
										@endif
										@if($row_price->promotion_price > 0)
											<div class="beta-unit-price">{{$row_price->unit_price}} VNĐ</div>
											<div class="beta-sales-price">{{$row_price->promotion_price}} VNĐ</div>
										@endif
									</div>
								</div>
							@endforeach
				...
				<div class="image-box">
					<div class="img-banner effect">
						<a href="#">
							<img src="//hstatic.net/153/1000104153/1000145997/sidebar_bannerone.png?v=656" alt="Adv Banner" class="img-responsive">
						</a>
					</div>
				</div>
